import { Building2, GraduationCap, Mountain, Users } from "lucide-react";
...
export function PillarsSection() {
  return (
    <Reveal as="section" className="bg-[#050505] py-20 md:py-28">
      ...
      {/* Carousel */}
      <div className="hide-scrollbar flex snap-x snap-mandatory scroll-smooth overflow-x-auto px-4 pb-6 sm:px-8 lg:px-16">

...
export function HeroSection() {
  return (
    <section className="relative bg-brand-ink overflow-hidden lg:min-h-[100dvh]">
      ...
      <Container className="relative z-10 flex flex-col pt-24 pb-12 sm:pt-28 sm:pb-14 lg:min-h-[100dvh] lg:justify-center lg:pt-28 lg:pb-16">
        <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-16">
          ...
          <Reveal delay={0.12}>
            <div className="relative mx-auto flex w-full max-w-md justify-center lg:mx-0 lg:ml-auto lg:max-w-none lg:justify-end">
              <div
                aria-hidden
                className="pointer-events-none absolute -right-4 bottom-0 h-[min(420px,50vh)] w-[min(420px,90vw)] rounded-full bg-gradient-to-t from-brand-gold/10 via-brand-teal/5 to-transparent blur-3xl lg:h-[min(480px,55vh)] lg:w-[min(480px,45vw)]"
              />
              <div className="relative h-[min(380px,52vh)] w-full max-w-sm sm:h-[min(420px,50vh)] lg:h-[min(480px,min(72vh,560px))] lg:max-w-md">
                <Image

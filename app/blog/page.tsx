...
export default function Page() {
  return (
    <main className="mx-auto max-w-2xl px-6 pb-16 pt-28 font-body text-brand-teal">
      <h1 className="font-sans text-3xl font-bold text-brand-navy">Blog</h1>
      <p className="mt-4 text-lg leading-relaxed">Raw insights, personal lessons, practical clarity.</p>
